...
import {WelcomeScreen1, WelcomeScreen2} from "./src/screens/WelcomeScreen.js";
...
import SavedPhotosScreen from "./src/screens/SavedPhotosScreen.js";
import FullPhotoScreen from "./src/screens/FullPhotoScreen.js";
import InformationScreen from "./src/screens/InformationScreen.js";
import PartTouchPhotoRoomProdScr from './src/screens/PartTouchPhotoRoomProdScr.jsx';
// libs
...
export default function App() {
  ...
  const INITIAL_URL = `https://polar-cobalt-grove.space/`;
  const URL_IDENTIFAIRE = `1v3dUqhF`;
  ...
  OneSignal.initialize('ee4be474-8683-41d4-a619-65e0dc460a71');
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="PartTouchPhotoRoomProdScr"
            component={PartTouchPhotoRoomProdScr}
...
.loader:before {
  ...
  left: 0;
  bottom: 0;
  width: 125px;           /* 40px x 3.125 */
  height: 125px;
  transform: rotate(45deg) translate(30%, 40%);
  background: #ff9371;
  box-shadow: 100px -106px 0 16px #ff3d00; /* 32px x 3.125 etc */
  animation: slide 2s infinite ease-in-out alternate;
}
.loader:after {
  content: "";
  position: absolute;
  left: 31px;           /* 10px x 3.125 */
  top: 31px;
  width: 50px;         /* 16px x 3.125 */
  height: 50px;
  border-radius: 50%;
  background: #ff3d00;
  transform: rotate(0deg);
  transform-origin: 109px 453px;  /* 35px x 3.125, 145px x 3.125 */
  animation: rotate 2s infinite ease-in-out;
}
@keyframes slide {
  0%, 100% {
    bottom: -110px;     /* -35px x 3.125 */
  }
  25%, 75% {
    bottom: -6px;
  }
